  ...
  return (
    <header className="flex items-center justify-between px-16 py-2">
     ...
     <nav className={`hidden md:flex space-x-4 ${isMobileMenuOpen ? 'flex' : 'hidden'}`}>
      ...
      <img src={flag} alt='image' className='w-10 h-10'/>
      <img src={user} alt='image' className='w-10 h-10'/>
      </div>
    </header>
  );
};
