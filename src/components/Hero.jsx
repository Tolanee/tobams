    ...
    return(
      ...
      <div className=" border-0 h-16 ">
        <div className=" md:inline-flex items-center gap-2 justify-center  left-0 ">
          <div className="items-center md:items-start md:flex-row flex flex-col space-y-2 md:space-y-0 relative">
            <div className=" bg-white border-[#d8d8d8b2] border-r border-r-1 h-16 w-5/6 flex items-center justify-center  md:w-[536px]">
            ...
            <div className=" bg-white h-16 relative w-5/6 md:w-[248px]">
            ...
            <div className=" bg-[#811141] h-16 relative w-5/6 md:w-[88px] flex justify-center items-center">
