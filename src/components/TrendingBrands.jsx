...
export default function TrendingBrands(){
    ...
    return (
      ...
      {data.map((item, index) => (
        ...
        >
          <div className="mt-5 self-start border border-gray-3 p-2 rounded-md shadow-md hover:-translate-y-3 hover:scale-100 transition ease-out duration-300 delay-700">
